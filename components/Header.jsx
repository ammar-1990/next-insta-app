    ...
    <header className="shadow-sm bg-white border-b sticky top-0 z-50">
      <div className="max-w-[1150px] mx-auto flex justify-between  py-2 items-center px-2 lg:py-0">
        ...
        <div className="flex items-center relative max-w-xl ">
          ...
          <input
            className="pl-8 outline-none focus:ring-1 mx-1 py-1 border-2 rounded-md w-[150px] sm:w-auto focus:border-black border-gray-400 focus:ring-black"
            type="text"
            placeholder="search"
          />
        </div>
        ...
        <div className="flex sm:gap-6 gap-2 items-center">
          ...
          <PlusCircleIcon
            ...
            className="postIcon flex-shrink-0"
          />
